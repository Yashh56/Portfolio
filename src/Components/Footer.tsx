...
const Footer = () => {
  return (
    <div className="flex max-md:w-full bg-[#171717] sm:min-w-fit justify-center items-center h-[40vh]">
      <div>
        ...
        <p className=" justify-center text-center mt-10">© Yash Saini 2024</p>
      </div>
    </div>
  )
}

...
const Projects = () => {
  ...
  return (
    <>
      <h1 className='text-4xl text-center md:mt-16 text-white'>PROJECTS</h1>
      ...
      <div className='flex max-md:flex-col flex-wrap md:mt-12 justify-center items-center text-center'>
